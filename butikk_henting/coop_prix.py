...
# -*- coding: utf-8 -*-
"""
coop_prix_screenshot_to_pdf.py

- Åpner Coop Prix kundeavis (https://www.coop.no/coop-prix/kundeavis)
...
# Konfigurasjon
URL = "https://kundeavis.coop.no/aviser/?id=4574"
STORE = "coop_prix"
...
def close_newsletter_popup(page):
    """
    Lukker eller fjerner nyhetsbrev-popup for Coop Prix.
    ...
    NEWSLETTER_SELECTORS = [
        ...
        "button:has-text('MELD DEG PÅ HER')",  # spesifikk for Prix-popup
    ]
        ...
        ok = page.evaluate(
            ...
            () => {
                ...
                for (const img of imgs) {
                    ...
                    // Coop Prix har <img class="rm" src="/aviser/assets/images/arrow_rm.png">
